...
class TestFeatures(TestCase):
    ...
    def test_custom_standard_scaler(self):
        ...
        reconstructed_data = scaler.mean + transformed_data * scaler.std
        self.assertTrue(np.allclose(reconstructed_data, data), "Custom test failed: Data reconstruction failed")
